...
var _userpost = _interopRequireDefault(__webpack_require__(/*! ./pages/user/userpost.vue */ 80));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
...
/* harmony import */ var _userpost_vue_vue_type_template_id_2e8844f4___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./userpost.vue?vue&type=template&id=2e8844f4& */ 81);
/* harmony import */ var _userpost_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./userpost.vue?vue&type=script&lang=js& */ 83);
...
/* harmony import */ var _userpost_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./userpost.vue?vue&type=style&index=0&lang=css& */ 85);
...
var API = __webpack_require__(/*! ../../utils/api */ 19);var Net = __webpack_require__(/*! ../../utils/net */ 20);var _default = { data: function data() {return { StatusBar: this.StatusBar, CustomBar: this.CustomBar, NavBar: this.StatusBar + this.CustomBar, page: 1, moreText: "加载更多", isLoad: 0, token: "", contentsList: [] };}, onPullDownRefresh: function onPullDownRefresh() {var that = this;that.getContentsList(false);var timer = setTimeout(function () {uni.stopPullDownRefresh();}, 1000);}, onReachBottom: function onReachBottom() {//触底后执行的方法，比如无限加载之类的
    var that = this;if (that.isLoad == 0) {that.loadMore();}}, onShow: function onShow() {var that = this;if (_index.localStorage.getItem('token')) {that.token = _index.localStorage.getItem('token');that.getContentsList(false);}that.page = 1;}, onLoad: function onLoad() {var that = this;that.NavBar = this.CustomBar;}, methods: {
    back: function back() {
      uni.navigateBack({
        delta: 1 });
