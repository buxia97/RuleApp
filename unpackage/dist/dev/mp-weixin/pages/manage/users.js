...
var _users = _interopRequireDefault(__webpack_require__(/*! ./pages/manage/users.vue */ 415));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
...
/* harmony import */ var _users_vue_vue_type_template_id_722206d7___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./users.vue?vue&type=template&id=722206d7& */ 416);
/* harmony import */ var _users_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./users.vue?vue&type=script&lang=js& */ 418);
...
/* harmony import */ var _users_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./users.vue?vue&type=style&index=0&lang=css& */ 420);
...
//
//
var API = __webpack_require__(/*! ../../utils/api */ 19);var Net = __webpack_require__(/*! ../../utils/net */ 20);var _default = { data: function data() {return { StatusBar: this.StatusBar, CustomBar: this.CustomBar, NavBar: this.StatusBar + this.CustomBar, userList: [], page: 1, moreText: "加载更多", isLoad: 0, searchText: "", isLoading: 0 };}, onPullDownRefresh: function onPullDownRefresh() {var that = this;that.page = 1;that.getUserList(false);var timer = setTimeout(function () {uni.stopPullDownRefresh();}, 1000);}, onReachBottom: function onReachBottom() {//触底后执行的方法，比如无限加载之类的
    var that = this;if (that.isLoad == 0) {that.loadMore();}}, onShow: function onShow() {var that = this;}, onLoad: function onLoad() {var that = this;that.NavBar = this.CustomBar;that.getUserList(false);}, methods: { allCache: function allCache() {var that = this;if (_index.localStorage.getItem('userList')) {that.userList = JSON.parse(_index.localStorage.getItem('userList'));}}, back: function back() {uni.navigateBack({ delta: 1 });}, toEdit: function toEdit(id) {var that = this;uni.navigateTo({ url: '../manage/usersedit?uid=' + id });
    },
