...
var _commentsadd = _interopRequireDefault(__webpack_require__(/*! ./pages/contents/commentsadd.vue */ 206));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
...
/* harmony import */ var _commentsadd_vue_vue_type_template_id_6c15629e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./commentsadd.vue?vue&type=template&id=6c15629e& */ 207);
/* harmony import */ var _commentsadd_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./commentsadd.vue?vue&type=script&lang=js& */ 209);
...
/* harmony import */ var _commentsadd_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./commentsadd.vue?vue&type=style&index=0&lang=css& */ 211);
...
//
//
var API = __webpack_require__(/*! ../../utils/api */ 19);var Net = __webpack_require__(/*! ../../utils/net */ 20);var _default = { data: function data() {return { StatusBar: this.StatusBar, CustomBar: this.CustomBar, NavBar: this.StatusBar + this.CustomBar, title: "", coid: 0, isreply: 0, cid: 0, text: "", userinfo: {}, token: "" };}, onPullDownRefresh: function onPullDownRefresh() {var that = this;}, onShow: function onShow() {var that = this; //获取用户信息
    if (_index.localStorage.getItem('userinfo')) {that.userinfo = JSON.parse(_index.localStorage.getItem('userinfo'));}if (_index.localStorage.getItem('token')) {that.token = _index.localStorage.getItem('token');}}, onLoad: function onLoad(res) {var that = this;
