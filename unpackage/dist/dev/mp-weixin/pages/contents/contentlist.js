...
var _contentlist = _interopRequireDefault(__webpack_require__(/*! ./pages/contents/contentlist.vue */ 214));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
...
/* harmony import */ var _contentlist_vue_vue_type_template_id_4e50b7ca___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./contentlist.vue?vue&type=template&id=4e50b7ca& */ 215);
/* harmony import */ var _contentlist_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./contentlist.vue?vue&type=script&lang=js& */ 217);
...
/* harmony import */ var _contentlist_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./contentlist.vue?vue&type=style&index=0&lang=css& */ 219);
...
var API = __webpack_require__(/*! ../../utils/api */ 19);var Net = __webpack_require__(/*! ../../utils/net */ 20);var _default = { data: function data() {return { StatusBar: this.StatusBar, CustomBar: this.CustomBar, NavBar: this.StatusBar + this.CustomBar, title: "", type: "", id: 0, contentsList: [], page: 1, moreText: "加载更多", isLoad: 0, metaList: [{ mid: 0, name: "全部", parent: 0 }], TabCur: 0, scrollLeft: 0, isLoading: 0 };}, onPullDownRefresh: function onPullDownRefresh() {var that = this;}, onReachBottom: function onReachBottom() {//触底后执行的方法，比如无限加载之类的
    ...
    that.id = res.id;if (res.type != "") {if (that.type == "meta") {
