	...
	<view class="user" :class="$store.state.AppStyle">
		...
		<form>
			<view class="cu-form-group margin-top">
				<view class="title">时间（天）</view>
				<input placeholder="请输入天数" name="input" type="number" v-model="day"></input>
			</view>
		...
		<!--  #ifdef MP -->
		<view class="post-update bg-blue" @tap="giftVIP">
