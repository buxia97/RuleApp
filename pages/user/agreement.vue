<template>
	<view class="header" :style="[{height:CustomBar + 'px'}]">
		...
		<scroll-view scroll-y class="agreement">
			...
			<view class="agreement-text">8.1.1.9含有虚假、有害、胁迫、侵害他人隐 私、骚扰、侵害、中伤、粗俗、猥亵、或其它道德上令人反感的内容；</view>
			...
			<view class="agreement-text">8.2用户违反本协议的规定，给{{appname}}造成 损失，或者导致的任何第三方主张的包括合理的 律师费、调查费在内的任何索赔、要求或损失，您同意赔偿{{appname}}与合作公司、关联公司，并使之免受损害。对此，{{appname}}有权视用户的行为性质，采取包括但不限于删除用户发布信息内容、暂停使用许可、终止服务、限制使用、回收{{appname}}账号、追究法律责任等措施。对恶意注册{{appname}}账号或利用{{appname}}账号进行违法活动、捣乱、骚扰、欺 骗、其他用户以及其他违反本协议的行为，{{appname}} 有权回收其账号。同时，{{appname}}会视司法部门的要求，协助调查。</view>
			...
			<view class="agreement-text">9.1{{appname}}对根据本服务或经本服务获得的所有信息，包括但不限于文本、图片、视频、音 频、图标、应用、设计、软件、脚本、程序、版权、商标、商号、专利等{{appname}}提供的内容保留所有权 利。除非本协议另行约定，否则您对本服务的访问、使用并不构成本服务或其中内容的任何所有权或其它权利向您或其他任何人的转移。</view>
			<view class="agreement-text">9.2对您上传、发布及以其它方式传输至本服务或通过本服务传输的的文本、文件、图片、照片、视频、音频或其它信息（如评论、问题与建 议）您继续保留上述内容的所有权，并对其负责。 若您的评论内容被反映或实际侵犯本协议第8条使用规则的约定，我们可能不经您同意，对您的评 论内容做屏蔽、删除等处理。</view>
			...
			<view class="agreement-text">9.3.1权利人对涉嫌侵权内容拥有知识产权或其他合法权益和/或依法可以行使知识产权或其 他合法权益的权属证明；</view>
			<view class="agreement-text">9.3.2请充分、明确地描述被侵犯了知识产权或其他合法权益的情况并请提供涉嫌侵权的第三 方网址（如果有）。</view>
			...
			<view class="agreement-text">您同意{{appname}}有权基于其自行之考虑，因任 何理由，包含但不限于长时间未使用，或{{appname}}认为您已经违反本服务协议的文字及精神，终止您的密码、账号或本服务之使用（或服务之任何部 分），并将您在本服务内任何内容加以移除并删除。您同意依本注册协议任何规定提供之本服务，无需进行事先通知即可中断或终止，您承认并同意，{{appname}}可立即关闭或删除您的账号及您账号中所有相关信息及文件，及/或禁止继续使用前述文件或本眼务。您已下载到自己可控的指定客户端（设备）上的数据资源，可以继续使用。此外，您同意若本服务之使用被中断或终止或您的账号 及相关信息和文件被关闭或删除，{{appname}}对您或任何第三人均不承担任何责任。</view>
